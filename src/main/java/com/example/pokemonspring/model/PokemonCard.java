package com.example.pokemonspring.model;
...
public PokemonCard(int pokedex_number, String name, String primary_type){
    this.name=name;
    this.primary_type = primary_type;
    this.pokedex_number=pokedex_number;
}

    public PokemonCard(int pokedex_number, String name, int speed, int special_defence, int special_attack, int defence, int attack, int hp, String primary_type,
